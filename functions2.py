...
# Second example program with multiple functions. This program
# contains a value-returning function.
...
def main ():
    ...
    three = 0
    max = 0        # this will contain the calculated max
    ...
    # findMax determines and then returns the max
